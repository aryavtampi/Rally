...
const SEED_EVENTS: EventItem[] = [
  {
    ...
    category: 'workshop',
    going: [
      SEED_ATTENDEES[0], SEED_ATTENDEES[1], SEED_ATTENDEES[2], SEED_ATTENDEES[3],
      SEED_ATTENDEES[4], SEED_ATTENDEES[5], SEED_ATTENDEES[6], SEED_ATTENDEES[7], SEED_ATTENDEES[8],
      { id: 'cw1', name: 'Aiden Park', avatarUrl: '' },
      { id: 'cw2', name: 'Bella Torres', avatarUrl: '' },
      { id: 'cw3', name: 'Carter Young', avatarUrl: '' },
      { id: 'cw4', name: 'Diana Reeves', avatarUrl: '' },
      { id: 'cw5', name: 'Ethan Lowe', avatarUrl: '' },
      { id: 'cw6', name: 'Fiona Grant', avatarUrl: '' },
      { id: 'cw7', name: 'Gavin Holt', avatarUrl: '' },
      { id: 'cw8', name: 'Hannah Price', avatarUrl: '' },
      { id: 'cw9', name: 'Isaac Chen', avatarUrl: '' },
      { id: 'cw10', name: 'Julia Watts', avatarUrl: '' },
      { id: 'cw11', name: 'Kevin Dunn', avatarUrl: '' },
      { id: 'cw12', name: 'Lara Finch', avatarUrl: '' },
      { id: 'cw13', name: 'Marco Silva', avatarUrl: '' },
      { id: 'cw14', name: 'Nora Blake', avatarUrl: '' },
      { id: 'cw15', name: 'Oscar Penn', avatarUrl: '' },
      { id: 'cw16', name: 'Priya Sharma', avatarUrl: '' },
      { id: 'cw17', name: 'Quinn Ross', avatarUrl: '' },
      { id: 'cw18', name: 'Ryan Cole', avatarUrl: '' },
      { id: 'cw19', name: 'Sofia Lane', avatarUrl: '' },
      { id: 'cw20', name: 'Tyler Knox', avatarUrl: '' },
      { id: 'cw21', name: 'Uma Patel', avatarUrl: '' },
      { id: 'cw22', name: 'Victor Chang', avatarUrl: '' },
      { id: 'cw23', name: 'Wendy Marsh', avatarUrl: '' },
      { id: 'cw24', name: 'Xavier Vega', avatarUrl: '' },
      { id: 'cw25', name: 'Yara Odom', avatarUrl: '' },
      { id: 'cw26', name: 'Zane Porter', avatarUrl: '' },
      { id: 'cw27', name: 'Alma Rivera', avatarUrl: '' },
      { id: 'cw28', name: 'Bryce Neal', avatarUrl: '' },
      { id: 'cw29', name: 'Celine Tran', avatarUrl: '' },
      { id: 'cw30', name: 'Derek Flynn', avatarUrl: '' },
      { id: 'cw31', name: 'Elena Cruz', avatarUrl: '' },
      { id: 'cw32', name: 'Felix Ortiz', avatarUrl: '' },
      { id: 'cw33', name: 'Grace Kim', avatarUrl: '' },
      { id: 'cw34', name: 'Hugo Bell', avatarUrl: '' },
      { id: 'cw35', name: 'Iris Stanton', avatarUrl: '' },
      { id: 'cw36', name: 'Jake Murray', avatarUrl: '' },
      { id: 'cw37', name: 'Kira Adams', avatarUrl: '' },
      { id: 'cw38', name: 'Leo Barrett', avatarUrl: '' },
      { id: 'cw39', name: 'Mia Thornton', avatarUrl: '' },
      { id: 'cw40', name: 'Noah Fischer', avatarUrl: '' },
      { id: 'cw41', name: 'Olive Harper', avatarUrl: '' },
      { id: 'cw42', name: 'Paul Keane', avatarUrl: '' },
      { id: 'cw43', name: 'Rachel Stone', avatarUrl: '' },
      { id: 'cw44', name: 'Sam Whitfield', avatarUrl: '' },
      { id: 'cw45', name: 'Tessa Lloyd', avatarUrl: '' },
      { id: 'cw46', name: 'Uri Brennan', avatarUrl: '' },
      { id: 'cw47', name: 'Vera Dawson', avatarUrl: '' },
      { id: 'cw48', name: 'Will Ashford', avatarUrl: '' },
      { id: 'cw49', name: 'Xena Calloway', avatarUrl: '' },
      { id: 'cw50', name: 'Yusuf Bright', avatarUrl: '' },
      { id: 'cw51', name: 'Zara Webb', avatarUrl: '' },
      { id: 'cw52', name: 'Arlo Vasquez', avatarUrl: '' },
      { id: 'cw53', name: 'Bianca Lund', avatarUrl: '' },
      { id: 'cw54', name: 'Caleb Rios', avatarUrl: '' },
      { id: 'cw55', name: 'Daphne Welles', avatarUrl: '' },
      { id: 'cw56', name: 'Eli Hadley', avatarUrl: '' },
    ],
    interested: [
      { id: 'cw57', name: 'Freya Delgado', avatarUrl: '' },
      { id: 'cw58', name: 'Gabe Mills', avatarUrl: '' },
      { id: 'cw59', name: 'Heidi Cho', avatarUrl: '' },
      { id: 'cw60', name: 'Ivan Payne', avatarUrl: '' },
      { id: 'cw61', name: 'Jade Archer', avatarUrl: '' },
    ],
    createdAt: Date.now() - 1000000,
    postedBy: { id: 'org-oba', name: 'Oxford Business Association', avatarUrl: '' },
    posterIdentity: { type: 'org', orgName: 'Oxford Business Association', isVerified: true },
  },
  {
    id: 'e1',
